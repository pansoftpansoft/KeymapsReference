...
public class KeymapAdapter extends RecyclerView.Adapter<KeymapAdapter.KeymapViewHolder> {
    int[] id;
    String[] name;
    String[] section;
    ...
    int ListSize;
    public KeymapAdapter(int[] id_data, String[] name_data, String[] section_data, String[] descriptionEnKeymap_data, String[] codeWinKeymap_data) {
    ...
    @NonNull
    @Override
    public KeymapAdapter.KeymapViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        Log.d("mLog", "position = " + 100);
        Context context = parent.getContext();
        int layoutItem = R.layout.item_refernce;
    ...
    @Override
    public void onBindViewHolder(@NonNull KeymapAdapter.KeymapViewHolder holder, int position) {
